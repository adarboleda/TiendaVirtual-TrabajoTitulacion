...
function DashboardContent({ userInfo }: DashboardContentProps) {
    ...
    return (
        <>
            {/* Mostrar información del usuario autenticado en la parte superior */}
            <div className="grid mb-3">
                <div className="col-12">
                    <div className="card bg-blue-100 border-blue-300">
                        <div className="flex align-items-center justify-content-between">
                            <div>
                                <h4 className="text-blue-800 m-0">
                                    ¡Bienvenido, {userInfo?.nombre || userInfo?.username || 'Usuario'}!
                                </h4>
                                <p className="text-blue-600 m-0 mt-2">
                                    Sesión iniciada como: {userInfo?.email || 'N/A'}
                                </p>
                            </div>
                            <div>
