                ...
                <div className="layout-topbar-end">
                    <div className="layout-topbar-actions-end">
                        <ul className="layout-topbar-items">
                                ...
                                <div className="hidden">
                                    <ul className="list-none p-0 m-0">
                                        ...
                                        <li className="border-top-1 surface-border">
                                            <button
                                                className="py-2 px-3 flex gap-2 cursor-pointer text-color hover:text-red-500 w-full text-left border-none bg-transparent"
                                                onClick={handleLogout}
                                                disabled={logoutLoading}
                                            >
                                                <i className={`pi pi-fw ${logoutLoading ? 'pi-spin pi-spinner' : 'pi-sign-out'} text-lg`}></i>
                            ...
                            {/* NUEVO: Menú del usuario autenticado */}
                            {userInfo && (
                                <li>
                                    <StyleClass nodeRef={userMenuRef} selector="@next" enterClassName="hidden" enterActiveClassName="px-scalein" leaveToClassName="hidden" leaveActiveClassName="px-fadeout" hideOnOutsideClick>
                                        <a className="p-ripple flex align-items-center gap-2" ref={userMenuRef}>
                                            <Avatar 
                                                label={getUserInitials(userInfo)} 
                                                size="normal"
                                                style={{ backgroundColor: '#2196F3', color: '#ffffff' }}
                                            />
                                            <span className="font-medium text-color hidden md:block">
                                    ...
                                    <div className="hidden">
                                        <ul className="list-none p-0 m-0">
                                            ...
                                            <li>
                                                <a className="py-2 px-3 flex gap-2 cursor-pointer text-color hover:text-primary">
                                                    <i className="pi pi-fw pi-question-circle text-lg"></i>
                                                    <span>Ayuda</span>
                                                </a>
                                            </li>
                                            <li className="border-top-1 surface-border">
